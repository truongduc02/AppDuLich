...
public class TourTrungFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aView = inflater.inflate(R.layout.fragment_tour_trung, container, false);
    ...
    private void initView() {
        rcvTour = aView.findViewById(R.id.rcv_tour_trung);
