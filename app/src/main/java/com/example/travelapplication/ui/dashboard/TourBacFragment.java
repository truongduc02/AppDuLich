...
import com.example.travelapplication.ui.activity.CTSPActivity;
...
public class TourBacFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aView = inflater.inflate(R.layout.fragment_tour_bac, container, false);
        rcvTour = aView.findViewById(R.id.rcv_tour_bac);
